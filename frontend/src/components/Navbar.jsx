        ...
        <nav className="absolute z-50 top-0 left-0 w-full p-6 md:p-12 bg-transparent text-white">
            <div className="flex justify-between items-center w-full">
                ...
                <div className="hidden lg:block">
                    <button
                        className="px-4 py-2 rounded-full border border-white text-white cursor-pointer bg-opacity-90 backdrop-blur-2xl"
                        onClick={() => navigate("/Register")} // Now navigate is defined
                    >
                        Register With Us
                    </button>
                </div>
                ...
                <div className={`absolute top-full left-0 w-full bg-opacity-90 backdrop-blur-lg p-6 transition-transform 
                    ...
                    <ul className="flex flex-col space-y-4 text-white">
                        ...
                        bg-opacity-90 backdrop-blur-2xl w-full text-center mt-4"
                            onClick={() => {
                                navigate("/Register"); // Ensure navigation on mobile menu
                                setIsOpen(false);
                            }}
                        >
                            Register With Us
